...
const CustomersTransactionTable: React.FC<{ transactions: WalletTransaction[] }> = ({ transactions }) => {
      ...
      <table className="w-full text-left text-sm text-foreground">
        ...
        <thead className="bg-muted/50 border-b border-border text-xs font-semibold text-muted-foreground uppercase tracking-wider">
          <tr>
            ...
            <th scope="col" className="px-6 py-4">Movement</th>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col min-w-0">
                    ...
                    <span className="text-[10px] text-muted-foreground truncate">
                      {transaction.email || transaction.pidUser || 'No customer email'}
                    </span>
                  </div>
                </div>
              </td>
