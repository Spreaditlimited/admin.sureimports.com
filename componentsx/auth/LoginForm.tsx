...
const LoginForm = () => {
            ...
            const submitForm = async (e: React.FormEvent) => {
                        ...
                        if (data.successx) {login(data.userx);}
            ...
            <div className="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                <div className="relative hidden w-full items-center justify-center bg-[linear-gradient(225deg,rgba(239,18,98,1)_0%,rgba(67,97,238,1)_100%)] p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-28 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                    ...
                    <div className="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                        <Link href="/" className="ms-10 block w-20 lg:w-60">
                ...
                <div className="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    <div className="flex w-full max-w-[440px] items-center gap-2 lg:absolute lg:end-6 lg:top-6 lg:max-w-full">
                        <Link href="/" className="block w-8 lg:hidden">
                            <img src="/assets/images/logos/logo.png" alt="Logo" className="mx-auto w-10" />
                        </Link>
        ...
        <form className="space-y-5 dark:text-white" onSubmit={submitForm}>
            ...
            <div>
                <label className="flex cursor-pointer items-center">
                    ...
                    />
                    <span className="text-white-dark">Keep me logged-in for 1 week </span>
